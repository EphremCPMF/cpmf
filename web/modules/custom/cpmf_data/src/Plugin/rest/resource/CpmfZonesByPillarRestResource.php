 ...
 *
 * @RestResource(
 *   id = "cpmf_zones_by_pillar_rest_resource",
 *   label = @Translation("Cpmf zones by pillar rest resource"),
 *   uri_paths = {
 *     "canonical" = "/rest/zones-by-pillar/{pillar}"
 *   }
 * )
 */
class CpmfZonesByPillarRestResource extends ResourceBase {
      ...
      foreach ($zones as $nid => $zone) {
        ...
        if ($zone_value) {
          $zone_values[$nid] = [
            ...
            'pillar_value' => cpmf_data_get_zone_pillar_value($zone, $pillar_field)
          ];
        }
      }
